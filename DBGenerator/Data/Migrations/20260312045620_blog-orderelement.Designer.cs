...
namespace DBGenerator.Data.Migrations
{
    ...
    [Migration("20260312045620_blog-orderelement")]
    partial class blogorderelement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DBGenerator.Models.Ads.Ads", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DBGenerator.Models.Metas", b =>
                {
                    ...
                    b.Property<string>("Og_Description")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Og_Image")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Og_Title")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Og_Url")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DBGenerator.Models.Blog.Post", b =>
                {
                    b.HasOne("DBGenerator.Models.Blog.Category", "Category")
                        .WithMany("Posts")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DBGenerator.Models.Metas", "Metas")
                        .WithMany()
            ...
            modelBuilder.Entity("DBGenerator.Models.Blog.PostElement", b =>
                {
                    b.HasOne("DBGenerator.Models.Blog.Post", "Post")
                        .WithMany("Elements")
